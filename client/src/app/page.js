...
import { HiShoppingBag, HiArrowRight, HiChevronLeft, HiChevronRight, HiStar } from "react-icons/hi";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen -mt-[var(--header-total-height,100px)]" style={{ position: 'relative', zIndex: 1 }}>
      ...
      <section className="relative h-[100vh] lg:h-[70vh] flex items-center justify-center bg-gradient-to-br from-pink-50 via-white to-pink-50 overflow-hidden" style={{ marginTop: 0, paddingTop: 'var(--header-total-height, 100px)' }}>
        {/* Slide Container */}
        {heroSlides.length > 0 ? (
              ...
              >
                <div className="relative z-10 text-center px-5 max-w-5xl w-full">
                  <h1 className="text-2xl lg:text-5xl font-bold mb-6 text-black leading-tight drop-shadow-lg">
                    ...
                    {slide.subtitle && (
                      <span className="block text-[#FF6B9D]">{slide.subtitle}</span>
                    )}
                  </h1>
                  {slide.description && (
          ...
          <div className="relative w-full h-full flex items-center justify-center">
            <div className="text-center px-5 max-w-5xl w-full">
              ...
              <p className="text-base lg:text-lg text-gray-700 mb-10 max-w-2xl mx-auto">
                Discover our collection of high-quality wigs, extensions, and hair accessories.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link
                  href="/products"
      ...
      {categories.length > 0 && (() => {
        ...
        const pageCategories = categories.slice(pageStart, pageStart + categoriesPerPage);
        
        return (
          <section className="py-8 lg:py-16 px-2 md:px-5 lg:px-40 bg-white dark:bg-gray-900 transition-colors">
            <div className="flex items-center justify-between mb-6 lg:mb-8">
            <div className="flex items-center gap-2">
                <h2 className="text-lg lg:text-2xl font-bold text-gray-900 dark:text-white">Shop by Category</h2>
            </div>
            <Link
              href="/products"
                          ...
                          >
                            ...
                            <div className="w-[120px] h-[120px] mb-2 rounded-full overflow-hidden bg-gray-100 dark:bg-gray-800 flex items-center justify-center group-hover:opacity-80 transition shadow-sm">
                              {category.image_url ? (
                                ...
                                <HiShoppingBag size={48} className="text-[#FF6B9D]" />
                              )}
                            </div>
      ...
      <section className="py-16 px-2 md:px-5 lg:px-40 bg-gray-50 dark:bg-gray-800 transition-colors">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-2">
            <h2 className="text-xl lg:text-2xl font-bold text-gray-900 dark:text-white">Featured Products</h2>
          </div>
          <Link
            href="/products"
            className="text-[#FF6B9D] hover:underline font-semibold flex items-center gap-1 text-xs lg:text-base"
        ...
        {loading ? (
          <div className="text-center py-12">
            <p className="text-gray-900 dark:text-white">Loading featured products...</p>
          </div>
        ) : (
      ...
      <section className="py-16 px-2 md:px-5 lg:px-40 bg-white dark:bg-gray-900 transition-colors">
        <h2 className="text-xl lg:text-2xl font-bold mb-8 text-gray-900 dark:text-white">All Products</h2>
        <Listing />
      </section>
      ...
      <section className="py-16 px-5 lg:px-40 bg-white dark:bg-gray-900 transition-colors">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="font-bold text-base lg:text-lg mb-2 text-gray-900 dark:text-white">Free Shipping</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold text-base lg:text-lg mb-2 text-gray-900 dark:text-white">Premium Quality</h3>
            <p className="text-gray-600 dark:text-gray-400 text-base">
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold text-base lg:text-lg mb-2 text-gray-900 dark:text-white">Easy Returns</h3>
            <p className="text-gray-600 dark:text-gray-400 text-base">
