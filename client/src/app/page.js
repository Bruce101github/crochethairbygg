...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <section
        className="relative w-full h-[75vh] lg:h-[70vh] flex items-center justify-center bg-gradient-to-br from-pink-50 via-white to-pink-50 dark:bg-gray-900 overflow-hidden"
        style={{
          marginTop: 0,
