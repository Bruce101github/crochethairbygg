...
export default function Home() {
  ...
  return (
    <div className="min-h-screen -mt-[var(--header-total-height,100px)]" style={{ position: 'relative', zIndex: 1 }}>
      ...
      <section className="relative h-[75vh] lg:h-[70vh] flex items-center justify-center bg-gradient-to-br from-pink-50 via-white to-pink-50 overflow-hidden" style={{ marginTop: 0, paddingTop: 'var(--header-total-height, 100px)' }}>
        {/* Slide Container */}
        {heroSlides.length > 0 ? (
